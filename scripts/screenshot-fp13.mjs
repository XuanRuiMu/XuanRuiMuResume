...
const shots = [
  { name: 'fp13-01-landing', scroll: 0, clickEnter: false },
  { name: 'fp13-02-theater-main', scroll: 0, clickEnter: true },
  { name: 'fp13-03-it', scroll: 1, clickEnter: true },
  { name: 'fp13-04-edu', scroll: 2, clickEnter: true },
  { name: 'fp13-05-design', scroll: 3, clickEnter: true },
  { name: 'fp13-06-music', scroll: 4, clickEnter: true },
  { name: 'fp13-07-media', scroll: 5, clickEnter: true },
]
