...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative flex min-h-[calc(100vh-3.5rem)] items-center px-4 sm:px-6 lg:px-8"
      aria-label={t('nav.hero')}
    >
      <div className="mx-auto grid w-full max-w-6xl gap-12 py-16 md:grid-cols-2 md:py-24">
